...
![image](https://github.com/user-attachments/assets/11002507-196d-437b-a66b-be0dfbb41786)
...
so the bottom level of pyramid of pain highlights hashes . so we are going to look for the hash of the file we obtain the information below  

![image](https://github.com/user-attachments/assets/7b454587-53ac-4cfb-afa3-97cca823529d)

now we have few hashes . I am going to use the MD5 hash  

![image](https://github.com/user-attachments/assets/d9f51cad-dd14-4be8-a4ff-1a43e3ff63be)

now I received a confirmation Mail from the purple team that I detected the malware implemented now the ascending level of pyramid of pain says Ip address  

![image](https://github.com/user-attachments/assets/61bca0f7-619c-4b5b-ba5d-fdb719fcf7ac)

from the sandbox image below , we can see the ip address we need to block with the firewall  

![image](https://github.com/user-attachments/assets/51cfa489-955c-4099-9b5b-9699c72b94bf)

now we don't want any egress connection to that IP  

![image](https://github.com/user-attachments/assets/faef6571-2eda-49fd-a28a-3b9456623c7d)

Hooray , we did it agaiin  

![image](https://github.com/user-attachments/assets/585c6a4e-0aea-4440-b179-7d737cd1b2cf)

Now the third bottom pyramid level says domain names. so we will block the domain names from sample 3  

![image](https://github.com/user-attachments/assets/75a9fae5-ccd0-4096-a945-8bc8c800523a)

now we will no more receive any mail fom this domain  

![image](https://github.com/user-attachments/assets/2a8e4de5-56dd-46ef-9a8d-cf7805883bf2)
...
![image](https://github.com/user-attachments/assets/5690576a-d1e5-41f9-8a4f-53d9316a07ce)

we are going to create a sigma rule with the sysmon logs  

![image](https://github.com/user-attachments/assets/2025d270-f33c-49a4-a76c-1cb0686810c4)

we fill the rule with the information provided by the analysis  

![image](https://github.com/user-attachments/assets/7cc5ccad-0d74-481e-b19a-6df0209acc0a)

hooray . we did it  

![image](https://github.com/user-attachments/assets/6399e968-c5cd-4227-b4a8-4d47007a215c)

Now let's go with the sample 5 which matches the level " Tools" of the pyramid of pain  

![image](https://github.com/user-attachments/assets/e2be1d45-49c7-46e3-b677-308f03678ba4)

we see that there is an ongoing egress connection logs.

let's us fill that in our pico system  

![image](https://github.com/user-attachments/assets/c80600a1-e54f-46bc-8901-63aa50a1be30)

we have been able to get rid of the malicious sample 5  

![image](https://github.com/user-attachments/assets/98631899-93f3-49c3-83c7-0f8cb03032e9)

let's check the command logs from the malicious sample 6 which is from TTP  

![image](https://github.com/user-attachments/assets/87e946ba-36fe-4d07-984b-d98343c81a31)

still in the sysmonlog , let's head to the file creation and modification, and fill in data from the commands.log:  

![image](https://github.com/user-attachments/assets/39b7cce1-4dae-4cf1-bd96-fcf27ec7c13b)

finally we did it  

![image](https://github.com/user-attachments/assets/59bc9dd9-8676-4e5d-b5ce-0a44fe468629)
